      ...
      <div className="max-w-[1400px] mx-auto relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16">
          ...
          <div className="lg:col-span-7 flex items-start">
            <div className="contact-reveal w-full bg-white p-8 md:p-10 rounded-[28px] border border-[#1A1A1A]/[0.08]">
              {/* Toggle */}
              ...
              {mode === 'project' ? (
                submitted ? (
                  <div className="flex flex-col items-center justify-center py-16 gap-4">
                    <div className="w-16 h-16 rounded-full bg-[#F26044]/10 flex items-center justify-center mb-2">
                      <svg className="w-8 h-8 text-[#F26044]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
